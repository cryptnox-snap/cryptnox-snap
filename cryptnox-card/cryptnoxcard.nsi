...
;Variables
  ...
  !define PRODUCT_NAME "Cryptnox Card"
  !define SETUP_FILE_NAME "CryptnoxCard-setup"
...
;Interface Settings
  ...
  !define MUI_ICON "cryptnoxcard.ico"
...
Section
  ...
  File /r "dist\cryptnoxcard\*.*"
  File "cryptnoxcard.ico"
  ...
  CreateShortCut "$DESKTOP\${PRODUCT_NAME}.lnk" "$INSTDIR\cryptnoxcard.exe" "" "$INSTDIR\cryptnoxcard.ico"

  ;Create start-menu items
  DetailPrint "Creating start-menu items..."
  CreateDirectory "$SMPROGRAMS\${PRODUCT_NAME}"
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\Uninstall.lnk" "$INSTDIR\Uninstall.exe" "" "$INSTDIR\Uninstall.exe" 0
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\${PRODUCT_NAME}.lnk" "$INSTDIR\cryptnoxcard.exe" "" "$INSTDIR\cryptnoxcard.ico" 0
  ...
  WriteRegStr HKCU "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\cryptnoxcard.ico"
